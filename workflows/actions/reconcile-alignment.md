...
If a ratchet regression was detected in Phase 3, create a regression item that
...
3. The execution items created in Phase 7 are the primary output — they

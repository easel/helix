...
- `helix tracker status --json` reports `158` total issues, `7` open, `0` in-progress, and `150` closed; `helix tracker list --status deferred --json` still reports historical deferred issue `hx-e4d48132`.

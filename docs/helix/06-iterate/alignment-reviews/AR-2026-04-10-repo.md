...
- `docs/helix/03-test/test-plans/STP-002-helix-cli.md:34-45`
- `docs/helix/03-test/test-plans/STP-002-helix-cli.md:46-83`
...
- **Test Plans**: STP-002 requires deterministic proof for wrapper help, alignment-bead acquisition, queue-drain delegation, and queue/claim behavior, while the context-digest validator enforces live queue metadata hygiene (`docs/helix/03-test/test-plans/STP-002-helix-cli.md:34-83`).

...
generated: true
aliases:
  - /reference/glossary/artifacts/solution-design
---
...
`docs/helix/02-design/solution-designs/SD-{id}-{name}.md`
...
This example is HELIX's actual solution design, sourced from [`docs/helix/02-design/solution-designs/SD-001-helix-supervisory-control.md`](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/02-design/solution-designs/SD-001-helix-supervisory-control.md). It shows how this artifact is used in a live methodology project; it may include project-specific context.

## Solution Design

### Scope

**Feature**: [FEAT-002-helix-cli](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/01-frame/features/FEAT-002-helix-cli.md) (the CLI surface that realizes the supervisory control model) | **PRD**: [docs/helix/01-frame/prd.md](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/01-frame/prd.md) | **ADR**: [ADR-001](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/02-design/adr/ADR-001-supervisory-control-model.md) | **Contract**: [CONTRACT-001](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/02-design/contracts/CONTRACT-001-ddx-helix-boundary.md)

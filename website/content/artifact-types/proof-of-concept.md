...
generated: true
aliases:
  - /reference/glossary/artifacts/proof-of-concept
---
...
`docs/helix/02-design/proofs-of-concept/`

## Relationships

### Requires (upstream)

- [Technical approach defined](../solution-design/)
- [Architecture decisions made](../adr/) *(optional)*

### Enables (downstream)

- [Refined technical approach](../solution-design/)
- [Implementation guidance](../implementation-plan/)

...
- [Build Plan — Slider Autonomy (FEAT-011)](/artifacts/implementation-plan/)
- [Implementation Plan — 2026-04-11 Live Queue Snapshot](/artifacts/implementation-plan-2026-04-11-snapshot/)

## Deploy

- [Deployment Checklist — HELIX Plugin and Website Release](/artifacts/deployment-checklist/)
- [Monitoring Setup — `ddx-server`](/artifacts/monitoring-setup/)
- [Release Notes — HELIX v0.3.3](/artifacts/release-notes/)
- [Runbook — `ddx-server`](/artifacts/runbook/)
- [decisions](/artifacts/decisions/) _(4 items)_

## Iterate

- [Improvement Backlog — HELIX 2026-Q2](/artifacts/improvement-backlog/)

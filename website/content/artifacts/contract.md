...
This example is HELIX's actual contract, sourced from [`docs/helix/02-design/contracts/CONTRACT-001-ddx-helix-boundary.md`](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/02-design/contracts/CONTRACT-001-ddx-helix-boundary.md). It shows how this artifact is used in a live methodology project; it may include project-specific context.

## CONTRACT-001: DDx / HELIX Boundary Contract

**Status:** Draft  
**Owner:** HELIX maintainers  
**Related:** [Product Vision](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/00-discover/product-vision.md), [FEAT-011](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/01-frame/features/FEAT-011-slider-autonomy.md), [ADR-001](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/02-design/adr/ADR-001-supervisory-control-model.md)
...
- execution-document authoring conventions for HELIX artifacts (see [CONTRACT-002](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/02-design/contracts/CONTRACT-002-helix-execution-doc-conventions.md))
...
- [FEAT-011: Slider Autonomy Control](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/01-frame/features/FEAT-011-slider-autonomy.md)
- [ADR-001: HELIX Supervisory Control Model](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/02-design/adr/ADR-001-supervisory-control-model.md)
- [API-001: HELIX Tracker Mutation Surface](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/02-design/contracts/API-001-helix-tracker-mutation.md)
- [CONTRACT-002: HELIX Execution-Document Conventions](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/02-design/contracts/CONTRACT-002-helix-execution-doc-conventions.md)

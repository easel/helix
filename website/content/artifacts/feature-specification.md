...
This example is HELIX's actual feature specification, sourced from [`docs/helix/01-frame/features/FEAT-002-helix-cli.md`](https://github.com/DocumentDrivenDX/helix/blob/main/docs/helix/01-frame/features/FEAT-002-helix-cli.md). It shows how this artifact is used in a live methodology project; it may include project-specific context.

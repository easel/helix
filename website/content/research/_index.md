...
|---|---|
| [Agile Manifesto](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/agile-manifesto.md) and [Agile principles](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/agile-manifesto-principles.md) | HELIX preserves change-friendly iteration, working-software feedback, simplicity, and regular reflection, but makes the supporting intent durable for agent sessions. |
| [Amazon / AWS Working Backwards PR-FAQ](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/amazon-working-backwards-prfaq.md) | HELIX uses the PR-FAQ as a Frame artifact that turns a future customer outcome, FAQ objections, risks, and validation questions into a durable product argument before requirements harden. |
| [Working Backwards PR-FAQ template guidance](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/working-backwards-prfaq-template.md) | HELIX keeps PR-FAQ authoring customer-backward, plain-language, reviewable, and tied to downstream artifacts rather than treating it as launch copy. |
| [Twelve-Factor App](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/12-factor-app.md) and [methodology notes](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/twelve-factor-app-methodology.md) | HELIX's runtime-neutral boundary follows the same portability instinct: config, execution, and deployment concerns should be explicit rather than hidden in one environment. |
| [DevSecOps best practices](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/devsecops-best-practices-2025.md) | Security and quality belong throughout the lifecycle, not as late gates. HELIX models them as cross-cutting concerns and first-class artifacts. |
| [SAFe 6.0 enterprise patterns](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/safe-framework-2025.md) | HELIX keeps alignment, built-in quality, transparency, and objective evaluation, while staying smaller and repository-native rather than enterprise-process-heavy. |
| [Team Topologies and platform engineering](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/team-topologies-platform-engineering-2025.md) | HELIX reduces cognitive load by separating methodology from platform runtime and by giving agents a self-service artifact graph. |
| [HELIX 2025 evaluation](https://github.com/DocumentDrivenDX/helix/blob/main/docs/resources/helix-evaluation-2025.md) | The evaluation identified strengths to preserve, including test-first discipline, phase gates, human-AI responsibility boundaries, documentation templates, and iterative learning. It also drove the current collapse toward a smaller methodology-plus-skill surface. |

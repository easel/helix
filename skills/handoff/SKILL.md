...
1. **Identify what changed** — check recent commits, modified files, new or
   updated issues, and any new planning artifacts.
...
2. **Assess quality** — for each change:
   ...
   - Were follow-on issues created for remaining work?
...
4. **Check for gaps** — did the other agent leave work incomplete? Are there
   open issues that should have been closed, or new work that wasn't captured
   as issues?
...
Be specific. Reference file paths, issue IDs, and commit hashes.
